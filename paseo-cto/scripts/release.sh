...
echo "  claude plugin marketplace add \"maggnus/claude-plugins@\${PASEO_CTO_TAG}\" --scope user"
...
echo "  codex plugin marketplace add maggnus/claude-plugins --ref \"\${PASEO_CTO_TAG}\""
